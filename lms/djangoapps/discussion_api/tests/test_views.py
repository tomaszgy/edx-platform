...
@httpretty.activate
@mock.patch.dict("django.conf.settings.FEATURES", {"ENABLE_DISCUSSION_SERVICE": True})
class RetireViewTest(DiscussionAPIViewTestMixin):
    """Tests for CourseView"""
    def setUp(self):
    ...
    def test_bad_hash(self):
        ...
        self.assert_response_correct(response, 500, '"Mismatched retired_username, bad salt?"')
    ...
    def test_nonexistent_user(self):
        ...
        self.hashed_username = get_retired_username_by_username(nonexistent_username)
